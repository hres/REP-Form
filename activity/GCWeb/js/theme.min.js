...
!function (a, b, c) {
    "use strict";
    var d = c.doc, e = "#wb-srch-q", f = a(e), g = a("#" + f.attr("list")), h = function (b) {
    ...
    d.on("change keyup", e, function (a) {
        var b = a.target, c = a.target.value, d = a.which;
        switch (a.type) {
            case"change":
                h.call(b, c);
                break;
        ...
        var b, d, e = a.fetch.response[1], h = e.length, i = "";
        ...
        var b = a(this), c = b.attr("data-reveal");
        b.find(c);
