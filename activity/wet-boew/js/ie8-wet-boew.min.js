...
window.Modernizr = function (a, b, c) {
    ...
    return a
}), Modernizr.addTest("cors", !!(window.XMLHttpRequest && "withCredentials" in new XMLHttpRequest)), /*! Respond.js v1.4.0: min/max-width media query polyfill. (c) Scott Jehl. MIT Lic. j.mp/respondjs  */
    function (a) {
        "use strict";
        function b() {
            u(!0)
        ...
        if (c.ajax = f, c.queue = d, c.regex = {
            ...
            var g, h, i, j = a.document, k = j.documentElement, l = [], m = [], n = [], o = {}, p = 30, q = j.getElementsByTagName("head")[0] || k, r = j.getElementsByTagName("base")[0], s = q.getElementsByTagName("link"), t = function () {
                ...
                if (b && g && r - g < p)return a.clearTimeout(h), void(h = a.setTimeout(u, p));
                g = r;
                ...
                for (var i = 0; i < f; i++) {
                    ...
                    for (var p = 0; p < o; p++)k = n[p], l.push({
    ...
    function n(a) {
        var b, c, d, e, f, g;
        if (e = parseFloat(a[0]) / 360 % 360, e < 0 && e++, f = m(l(a[1]), 0, 1), g = m(l(a[2]), 0, 1), 0 == f)b = c = d = g; else {
    ...
    function p(a) {
        ...
        if (a = String(a), "#" == a.charAt(0))b = a; else if (/^rgb/.test(a)) {
            for (var d, e = k(a), b = "#", f = 0; f < 3; f++)d = e[f].indexOf("%") != -1 ? Math.floor(255 * l(e[f])) : +e[f], b += Q[m(d, 0, 255)];
            c = +e[3]
        } else if (/^hsl/.test(a)) {
            var e = k(a);
            b = n(e), c = e[3]
    ...
    function r(a, b) {
        ...
        return "number" == typeof a.size ? c.size = a.size : a.size.indexOf("px") != -1 ? c.size = f : a.size.indexOf("em") != -1 ? c.size = e * f : a.size.indexOf("%") != -1 ? c.size = e / 100 * f : a.size.indexOf("pt") != -1 ? c.size = f / .75 : c.size = e, c.size *= .981, c
    }
    ...
    8 !== parseInt("08") && (parseInt = function (a) {
    ...
    }(parseInt)), Function.prototype.bind || (Function.prototype.bind = function (b) {
        var c = this;
        ...
        }, f = Math.max(0, c.length - d.length), g = [], h = 0; h < f; h++)g.push("$" + h);
    ...
    var s = Object("a"), t = "a" != s[0] || !(0 in s), u = !0;
    if (Array.prototype.forEach && Array.prototype.forEach.call("foo", function (a, b, c) {
            ...
            var b = H(this), c = t && "[object String]" == n(this) ? this.split("") : b, d = arguments[1], e = -1, f = c.length >>> 0;
            ...
            var b = H(this), c = t && "[object String]" == n(this) ? this.split("") : b, d = c.length >>> 0, e = Array(d), f = arguments[1];
            if ("[object Function]" != n(a))throw new TypeError(a + " is not a function");
            for (var g = 0; g < d; g++)g in c && (e[g] = a.call(f, c[g], g, b));
            return e
        }), Array.prototype.filter || (Array.prototype.filter = function (a) {
            var b, c = H(this), d = t && "[object String]" == n(this) ? this.split("") : c, e = d.length >>> 0, f = [], g = arguments[1];
            if ("[object Function]" != n(a))throw new TypeError(a + " is not a function");
            for (var h = 0; h < e; h++)h in d && (b = d[h], a.call(g, b, h, c) && f.push(b));
            return f
        }), Array.prototype.every || (Array.prototype.every = function (a) {
            var b = H(this), c = t && "[object String]" == n(this) ? this.split("") : b, d = c.length >>> 0, e = arguments[1];
            if ("[object Function]" != n(a))throw new TypeError(a + " is not a function");
            ...
            var b = H(this), c = t && "[object String]" == n(this) ? this.split("") : b, d = c.length >>> 0;
            if ("[object Function]" != n(a))throw new TypeError(a + " is not a function");
            ...
            var c = t && "[object String]" == n(this) ? this.split("") : H(this), d = c.length >>> 0;
            if (!d)return -1;
            var e = 0;
        ...
        Object.keys = function a(b) {
            ...
            var a = [];
            for (var c in b)o(b, c) && a.push(c);
            if (v)for (var d = 0, e = x; d < e; d++) {
                var f = w[d];
                o(b, f) && a.push(f)
            }
            return a
    ...
    var z = -621987552e5, A = "-000001";
    Date.prototype.toISOString && new Date(z).toISOString().indexOf(A) !== -1 || (Date.prototype.toISOString = function () {
        var a, b, c, d, e;
    ...
    var B = !1;
    try {
        B = Date.prototype.toJSON && null === new Date(NaN).toJSON() && new Date(z).toJSON().indexOf(A) !== -1 && Date.prototype.toJSON.call({
    ...
    if (2 !== "ab".split(/(?:ab)*/).length || 4 !== ".".split(/(.?)(.?)/).length || "t" === "tesst".split(/(s)*/)[1] || "".split(/.?/).length || ".".split(/()()/).length > 1 ? !function () {
        ...
        String.prototype.substr = function (a, b) {
            return D.call(this, a < 0 && (a = this.length + a) < 0 ? 0 : a, b)
        }
    }
    var E = "\t\n\v\f\r \xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029\ufeff";
