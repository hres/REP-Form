    ...
    return function a(b, c, d) {
        ...
        2: [function (a, b) {
            function c(a, b) {
                ...
                var h = g(f), i = c.projections.get(h.projName);
        ...
        28: [function (a, b) {
            ...
            function e(a, b, e) {
                a = d(a);
                var f, g = !1;
                return "undefined" == typeof b ? (b = a, a = h, g = !0) : ("undefined" != typeof b.x || Array.isArray(b)) && (e = b, b = a, a = h, g = !0), b = d(b), e ? c(a, b, e) : (f = {
                    forward: function (d) {
                        return c(a, b, d)
                    }, inverse: function (d) {
                        return c(b, a, d)
        ...
        29: [function (a, b) {
            ...
            l.prototype = {
                compare_datums: function (a) {
                    return this.datum_type === a.datum_type && (!(this.a !== a.a || Math.abs(this.es - a.es) > 5e-11) && (this.datum_type === d ? this.datum_params[0] === a.datum_params[0] && this.datum_params[1] === a.datum_params[1] && this.datum_params[2] === a.datum_params[2] : this.datum_type === e ? this.datum_params[0] === a.datum_params[0] && this.datum_params[1] === a.datum_params[1] && this.datum_params[2] === a.datum_params[2] && this.datum_params[3] === a.datum_params[3] && this.datum_params[4] === a.datum_params[4] && this.datum_params[5] === a.datum_params[5] && this.datum_params[6] === a.datum_params[6] : this.datum_type !== f && a.datum_type !== f || this.nadgrids === a.nadgrids))
        ...
        35: [function (a, b) {
            var c = a("./core");
            c.defaultDatum = "WGS84", c.Proj = a("./Proj"), c.WGS84 = new c.Proj("WGS84"), c.Point = a("./Point"), c.toPoint = a("./common/toPoint"), c.defs = a("./defs"), c.transform = a("./transform"), c.mgrs = a("mgrs"), c.version = a("../package.json").version, a("./includedProjections")(c), b.exports = c
        }, {
            "../package.json": 67,
            "./Point": 1,
            "./Proj": 2,
        ...
        64: [function (a, b) {
            ...
            b.exports = function a(b, k, l) {
                function m(a, b) {
                    return (a.datum.datum_type === e || a.datum.datum_type === f) && "WGS84" !== b.datumCode
                }

                var n;
                return Array.isArray(l) && (l = j(l)), b.datum && k.datum && (m(b, k) || m(k, b)) && (n = new i("WGS84"), a(b, n, l), b = n), "enu" !== b.axis && h(b, !1, l), "longlat" === b.projName ? (l.x *= c, l.y *= c) : (b.to_meter && (l.x *= b.to_meter, l.y *= b.to_meter), b.inverse(l)), b.from_greenwich && (l.x += b.from_greenwich), l = g(b.datum, k.datum, l), k.from_greenwich && (l.x -= k.from_greenwich), "longlat" === k.projName ? (l.x *= d, l.y *= d) : (k.forward(l), k.to_meter && (l.x /= k.to_meter, l.y /= k.to_meter)), "enu" !== k.axis && h(k, !0, l), l
            }
        ...
        65: [function (a, b) {
            ...
            function d(a, b) {
                var e;
                return Array.isArray(a) ? (e = a.shift(), "PARAMETER" === e && (e = a.shift()), void(1 === a.length ? Array.isArray(a[0]) ? (b[e] = {}, d(a[0], b[e])) : b[e] = a[0] : a.length ? "TOWGS84" === e ? b[e] = a : (b[e] = {}, ["UNIT", "PRIMEM", "VERT_DATUM"].indexOf(e) > -1 ? (b[e] = {
