...
(function () {
    ...
    angular
        ...
        .component('cmpActivityMain', {
            templateUrl: 'app/scripts/components/activityMain/tpl-activity-main_20161124_1532.html',
    ...
    function activityMainCtrl(ActivityService, ApplicationInfoService, hpfbFileProcessing, $scope, $window, $location, $translate) {
        ...
        /* vm.openHelp = function (type) {
         ...
         switch (type) {
         case'activityFile':
         helpLink = newUrl + "help-activity-load-" + currentLang + "_20161124_1532.html";
         $window.open(helpLink);
         break;
         case 'activityMain':
         helpLink = newUrl + "help-activity-main-" + currentLang + "_20161124_1532.html";
         $window.open(helpLink);
         break;

         case 'activityRep':
         helpLink = newUrl + "help-activity-rep-" + currentLang + "_20161124_1532.html";
         $window.open(helpLink);
         break;
         }
