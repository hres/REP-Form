 ...
 *
 * ```js
 *   var myAppDev = angular.module('myAppDev', ['dossierApp', 'ngMockE2E']);
 ...
 * <file name="app.js">
 *   var dossierApp = angular.module('dossierApp', []);
 *
 *   dossierApp.controller('main', function($http) {
 *     var ctrl = this;
 *
 *     ctrl.phones = [];
 *     ctrl.newPhone = {
 ...
 * </file>
 * <file name="e2e.js">
 *   var myAppDev = angular.module('myAppE2E', ['dossierApp', 'ngMockE2E']);
 *
 *   myAppDev.run(function($httpBackend) {
 *     var phones = [{name: 'phone1'}, {name: 'phone2'}];
 *
