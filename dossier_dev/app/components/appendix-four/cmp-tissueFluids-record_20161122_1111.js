...
(function () {
    ...
    angular
        ...
        .component('cmpTissuesFluidsRecord', {
            templateUrl: './app/components/appendix-four/tpl-tiissueFluids-record_20161122_1111.html',
    ...
    tissuesFluidsController.$inject = ['DossierLists', '$translate'];

    function tissuesFluidsController(DossierLists, $translate) {
        var vm = this;
        ...
        vm.updateConcat = function (alias, toAdd) {
            ...
            if (index === -1 && toAdd) {
                if (!vm.model.detailsConcat.length) {
                    vm.model.detailsConcat = translateText;
                } else {
                    vm.model.detailsConcat = vm.model.detailsConcat + "<br>" + translateText;
                }
