...
!function (a) {
    ...
    a.i18nDict = {
        ...
        "esc-key": "(botão ESC)",
        show: "Exibir",
        "tab-rot": {off: "Interromper a rotação das abas", on: "Iniciar a rotação das abas"},
        "tab-list": "Lista Tab",
        ...
        close: "Fechar",
        volume: "Volume",
        mute: {on: "Ativar o modo silencioso", off: "Desativar o modo silencioso"},
        cc: {off: "Ocultar a legenda", on: "Mostrar a legenda"},
        "cc-err": "Ocorreu um erro no carregamento da legenda",
        adesc: {on: "Ativar a descrição de áudio", off: "Desativar a descrição de áudio"},
        pos: "Posição atual:",
        dur: "Tempo total:",
...
}(wb), wb.doc.one("formLanguages.wb", function () {
