...
serverPage.serverRefTop = function (a, h) {
    a = a || {};
    return "\t\t\x3c!--[if gte IE 9 | !IE ]>\x3c!--\x3e<link href='" + '../wet-boew/assets/favicon.ico\' rel="icon" type="image/x-icon"><link rel="stylesheet" href=\'' + wet.builder.environment(a) + "css/theme.min.css'><link rel=\"stylesheet\" href='" + wet.builder.environment(a) + "cdts/cdtsfixes.css'>\x3c!--<![endif]--\x3e\x3c!--[if lt IE 9]><link href='" + '../wet-boew/assets/favicon.ico\' rel="shortcut icon" /><link rel="stylesheet" href=\'' +
