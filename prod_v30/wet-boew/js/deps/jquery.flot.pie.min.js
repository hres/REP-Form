        ...
        function g(b, e) {
            ...
            function g() {
                ...
                if (!(e >= j / 2 - a || e * t.series.pie.tilt >= k / 2 - b || e <= c)) {
                    ...
                    for (var f = 1; f <= c; f++)y.beginPath(), y.arc(0, 0, e, 0, 2 * Math.PI, !1), y.fill(), e -= f;
                    y.restore()
                }
            }
            ...
            function i() {
                function b(a, b, c) {
                    a <= 0 || isNaN(a) || (c ? y.fillStyle = b : (y.strokeStyle = b, y.lineJoin = "round"), y.beginPath(), Math.abs(a - 2 * Math.PI) > 1e-9 && y.moveTo(0, 0), y.arc(0, 0, e, f, f + a / 2, !1), y.arc(0, 0, e, f + a / 2, f + a, !1), y.closePath(), f += a, c ? y.fill() : y.stroke())
                }
            ...
            if (s) {
                ...
                y = e, x = !1, u = Math.min(j, k / t.series.pie.tilt) / 2, w = k / 2 + t.series.pie.offset.top, v = j / 2, "auto" == t.series.pie.offset.left ? (t.legend.position.match("w") ? v += l / 2 : v -= l / 2, v < u ? v = u : v > j - u && (v = j - u)) : v += t.series.pie.offset.left;
                var m = b.getData(), n = 0;
