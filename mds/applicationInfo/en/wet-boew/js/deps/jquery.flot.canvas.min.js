!function (a) {
    function b(b, f) {
        ...
        null == c && (d = h.prototype.getTextInfo, e = h.prototype.addText, c = h.prototype.render), h.prototype.render = function () {
            ...
            d += l.height / n.length / 2, d = "middle" == k ? Math.round(d - l.height / 2) : "bottom" == k ? Math.round(d - l.height) : Math.round(d), window.opera && window.opera.version().split(".")[0] < 12 && (d -= 2);
            for (var o, p = 0; o = m[p]; p++)if (o.x == c && o.y == d)return void(o.active = !0);
            o = {active: !0, lines: [], x: c, y: d}, m.push(o);
            for (var q, p = 0; q = n[p]; p++)"center" == j ? o.lines.push([Math.round(c - q.width / 2), d]) : "right" == j ? o.lines.push([Math.round(c - q.width), d]) : o.lines.push([Math.round(c), d]), d += q.height
        }
    }
