...
!function (a, b, c) {
    ...
    !function (a) {
        ...
        function f(b, c) {
            ...
            if (o.search(/mouse(down|up)|click/) > -1 && !b.which && (b.which = 1), o.search(/^touch/) !== -1 && (h = e(f), o = h.touches, j = h.changedTouches, k = o && o.length ? o[0] : j && j.length ? j[0] : d))for (m = 0, n = B.length; m < n; m++)i = B[m], b[i] = k[i];
            return b
        }
        ...
        M && c.addEventListener("click", function (b) {
            ...
            if (i)for (c = b.clientX, d = b.clientY, x = a.vmouse.clickDistanceThreshold, e = j; e;) {
                for (f = 0; f < i; f++)if (g = J[f], h = 0, e === j && Math.abs(g.x - c) < x && Math.abs(g.y - d) < x || a.data(e, z) === g.touchID)return b.preventDefault(), void b.stopPropagation();
                e = e.parentNode
            }
        }, !0)
    }(a, b, c), function (a) {
        ...
        a.event.special.scrollstart = {
            ...
            tapholdThreshold: 750, setup: function () {
                ...
                c.bind("vmousedown", function (d) {
                    ...
                    var j, k = d.target;
                    d.originalEvent;
                    c.bind("vmouseup", g).bind("vclick", i), f.bind("vmousecancel", h), j = setTimeout(function () {
