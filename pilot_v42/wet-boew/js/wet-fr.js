...
wet.builder.top = function (a, h) {
    ...
    b += '<div class="row"><div class="brand col-xs-8 col-sm-9 col-md-6">' +
        (!1 != a.siteMenu ? '<a href="https://www.canada.ca/fr.html">' : "") + '<object type="image/svg+xml" data=\'' + '../wet-boew/assets/sig-blk-fr.svg\'></object><span class="wb-inv"> Gouvernement du Canada / <span lang="en">Government of Canada</span></span>' + (!1 != a.siteMenu ? "</a>" : "") + '</div><section class="wb-mb-links col-xs-4 col-sm-3 ' + (!1 != a.siteMenu ? "visible-sm visible-xs" : "") + (!1 == a.siteMenu ? " hide" : "") + '" id="wb-glb-mn"><h2>Recherche et menus</h2><ul class="list-inline text-right chvrn"><li><a href="#mb-pnl" title="Recherche et menus" aria-controls="mb-pnl" class="overlay-lnk" role="button"><span class="glyphicon glyphicon-search"><span class="glyphicon glyphicon-th-list"><span class="wb-inv">Recherche et menus</span></span></span></a></li></ul><div id="mb-pnl"></div></section>' +
...
applicationPage.appTop = function (a, h) {
    var b = '\t\t<ul id="wb-tphp"><li class="wb-slc"><a class="wb-sl" href="#wb-cont">Passer au contenu principal</a></li><li class="wb-slc visible-sm visible-md visible-lg"><a class="wb-sl" href="#wb-info">Passer \u00e0 \u00ab&#160;' + (!0 == a.topCusMenu ? "Liens connexes" : "\u00c0 propos de cette application Web") + "&#160;\u00bb</a></li>" + (!0 == a.topSecMenu ? '<li class="wb-slc visible-md visible-lg"><a class="wb-sl" href="#wb-sec">Passer au menu de la section</a></li>' : "") +
        '</ul><header role="banner"><div id="wb-bnr" class="container"><div class="row"><div class="brand col-xs-9 col-sm-8 col-md-6"><object type="image/svg+xml" data=\'' + '../wet-boew/assets/sig-blk-fr.svg\'></object><span class="wb-inv"> Gouvernement du Canada / <span lang="en">Government of Canada</span></span></div>';
    if (null != a.lngLinks) {
